...
-- Members of a household can read it; the creator can update/delete it.
...
-- ─── household_state ────────────────────────────────────────────────────────
-- One row per household. `data` holds the entire Zustand store as JSON.
...
-- Realtime: emit changes to subscribed clients.
